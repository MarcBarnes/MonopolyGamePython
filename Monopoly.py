...
class Player:
    ...
    def move(self):
        ...
        #Show Dices
        if self.myDice.dice1:
            image1=dice_opts[self.myDice.dice1-1]
            image1 = pygame.transform.scale(image1, (120 , 120))
            screen.blit(image1, (840, 650))
        if self.myDice.dice2:
            image2 = dice_opts[self.myDice.dice2-1]
            image2 = pygame.transform.scale(image2, (120 , 120))
            screen.blit(image2, (980, 650))
...
def updateSideBar():
    ...
    currentPlayer = button(PLAYERCOLOR[players[(theBoard.totalTurnsTaken % theBoard.numPlayers)].number-1], 752 , pixelcount, 448, 30, "Player " + str(players[(theBoard.totalTurnsTaken % theBoard.numPlayers)].number) + "\'s turn", 24)
