...
class button():
    ...
    def draw(self, win, outline=None):
        # Call this method to draw the button on the self.screen
        if outline:
...
######### Must totally repaint board & players on a move. So functions need to change the player's position variable and then call makeNewBoard and... ##########
######### it will repaint the board with the players in the correct new positions #########
